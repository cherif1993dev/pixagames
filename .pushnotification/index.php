                    ...
                    <div class="col-xl-5 col-md-8">
                        <form method="post" class="bg-white rounded-5 shadow-5-strong p-5">
                            <div class="mb-4" align="center">
                                <img src="assets/images/envelope.png" width="80px">
                            ...
                            <div align="right">
                                <button type="submit" name="submit" class="btn btn-warning btn-lg btn-rounded">Send Notification</button>
                            </div>

                            <br>
                            <div align="center">
                                Copyright © 2024 <a href="#" target="_blank">Cherif</a>
                            </div>
